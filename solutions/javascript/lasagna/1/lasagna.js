...
/**
 * Determina cuántos minutos más necesita la lasaña en el horno.
 *
 * @param {number} actualMinutesInOven
 * @returns {number} los minutos restantes
 */
...
/**
 * Calcula el tiempo total trabajado: preparación + horneado actual.
 *
 * @param {number} numberOfLayers
 * @param {number} actualMinutesInOven
 * @returns {number} el tiempo total trabajado
 */
